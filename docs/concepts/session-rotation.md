...
| Amazon Nova 2 Sonic | 8 min per connection | `RotatingEngine`: a new connection prepared in the background, seeded with chat-history blocks ([details](../providers/aws-nova-sonic.md)) |
