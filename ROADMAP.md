...
- [ ] #10 Apple Silicon providers via MLX (parakeet-mlx / mlx-whisper STT, mlx-audio TTS, mlx-lm) `P2` — 🚧 wave 4
...
- [ ] #113 Turn-taking quality on the local cascade (premature replies, backchannel barge-ins, dead air) `P1` — 🚧 wave 4
...
- [ ] #51 Release automation: PyPI trusted publishing, changelog, versioning `P2` — 🚧 wave 4
...
- **Wave 4 (in progress):** turn-taking quality (#113), MLX on Apple Silicon (#10), release automation (#51).
